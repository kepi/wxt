...
describe('Auto Imports', () => {
  describe('imports: { ... }', () => {
    it('should generate a declaration file, imports.d.ts, for auto-imports', async () => {
      ...
      expect(await project.serializeFile('.wxt/types/imports.d.ts'))
        .toMatchInlineSnapshot(`
          ...
          export {}
          declare global {
            const ContentScriptContext: typeof import('wxt/client/content-scripts/context')['ContentScriptContext']
            const InvalidMatchPattern: typeof import('wxt/sandbox/match-patterns')['InvalidMatchPattern']
            const MatchPattern: typeof import('wxt/sandbox/match-patterns')['MatchPattern']
            const MigrationError: typeof import('wxt/storage')['MigrationError']
            const browser: typeof import('wxt/browser')['browser']
            const createIframeUi: typeof import('wxt/client/content-scripts/ui/createIframeUi')['createIframeUi']
            const createIntegratedUi: typeof import('wxt/client/content-scripts/ui/createIntegratedUi')['createIntegratedUi']
            const createShadowRootUi: typeof import('wxt/client/content-scripts/ui/createShadowRootUi')['createShadowRootUi']
            const defineAppConfig: typeof import('wxt/sandbox/defineAppConfig')['defineAppConfig']
            const defineBackground: typeof import('wxt/sandbox/defineBackground')['defineBackground']
            const defineConfig: typeof import('wxt')['defineConfig']
            const defineContentScript: typeof import('wxt/sandbox/defineContentScript')['defineContentScript']
            const defineUnlistedScript: typeof import('wxt/sandbox/defineUnlistedScript')['defineUnlistedScript']
            const defineWxtPlugin: typeof import('wxt/sandbox/defineWxtPlugin')['defineWxtPlugin']
            const fakeBrowser: typeof import('wxt/testing')['fakeBrowser']
            const injectScript: typeof import('wxt/client/injectScript')['injectScript']
            const storage: typeof import('wxt/storage')['storage']
            const useAppConfig: typeof import('wxt/client/useAppConfig')['useAppConfig']
          }
          "
        `);
    });
    ...
    it('should generate the #imports module', async () => {
      ...
      expect(await project.serializeFile('.wxt/imports.ts'))
        .toMatchInlineSnapshot(`
        ".wxt/imports.ts
        ----------------------------------------
        // Generated by wxt
        ...
        export { defineConfig } from 'wxt';
        export { useAppConfig } from 'wxt/client/useAppConfig';
        export { injectScript } from 'wxt/client/injectScript';
        export { ContentScriptContext } from 'wxt/client/content-scripts/context';
        export { createIntegratedUi } from 'wxt/client/content-scripts/ui/createIntegratedUi';
        export { createShadowRootUi } from 'wxt/client/content-scripts/ui/createShadowRootUi';
        export { createIframeUi } from 'wxt/client/content-scripts/ui/createIframeUi';
        export { defineAppConfig } from 'wxt/sandbox/defineAppConfig';
        export { defineBackground } from 'wxt/sandbox/defineBackground';
        export { defineContentScript } from 'wxt/sandbox/defineContentScript';
        export { defineUnlistedScript } from 'wxt/sandbox/defineUnlistedScript';
